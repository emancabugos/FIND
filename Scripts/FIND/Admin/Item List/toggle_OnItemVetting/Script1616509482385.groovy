...
WebUI.setText(findTestObject('FIND/ADMIN/Users List/textfield_Search'), 'GDA')

WebUI.click(findTestObject('FIND/ADMIN/Users List/button_Apply'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

WebUI.verifyTextPresent('GDA(AgencyDirect)', false)

WebUI.click(findTestObject('FIND/ADMIN/Items List/button_Toggle'))
