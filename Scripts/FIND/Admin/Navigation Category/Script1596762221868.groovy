...
WebUI.waitForElementVisible(findTestObject('ADMIN/Admin New Sidebar/submenu_Categories'), 0)

WebUI.click(findTestObject('ADMIN/Admin New Sidebar/submenu_Categories'))
