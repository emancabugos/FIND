...
WebUI.navigateToUrl(GlobalVariable.COVIDhomepageURL)

WebUI.waitForElementVisible(findTestObject('FIND/BUYER/Checkout/searchbox_homepage'), 0)

WebUI.comment('Search on Homepage')

WebUI.setText(findTestObject('FIND/BUYER/Checkout/searchbox_homepage'), 'COVID(AgencyFIND)')
...
WebUI.verifyElementPresent(findTestObject('FIND/BUYER/Checkout/btn_procureFIND'), 0)
