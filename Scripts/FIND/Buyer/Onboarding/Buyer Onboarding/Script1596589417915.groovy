...
WebUI.uploadFile(findTestObject('FIND/SELLER/onboardingProfile/put_image'), 'C:/Katalon/FIND/Images/SellerPhoto/1.png')
...
WebUI.setText(findTestObject('FIND/SELLER/onboardingProfile/textbox_DisplayName'), 'Mark')
...
WebUI.setText(findTestObject('FIND/SELLER/onboardingAddress/textbox_alternativeContactPerson'), 'Mark Twain')

WebUI.setText(findTestObject('FIND/SELLER/onboardingAddress/textbox_alternativeContactNumber'), '+63000001')

WebUI.setText(findTestObject('FIND/SELLER/onboardingAddress/textbox_alternativeEmail'), 'arcadier.tester2@gmail.com')
