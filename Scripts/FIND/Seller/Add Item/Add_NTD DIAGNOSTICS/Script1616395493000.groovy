...
WebUI.setText(findTestObject('FIND/SELLER/Add Item/input_ITEM NAME'), 'NTD DIAGNOSTICS')

WebUI.comment('Categories')

WebUI.click(findTestObject('FIND/SELLER/Add Item/Category/cat_NTD DIAGNOSTICS'))

WebUI.comment('Price')

WebUI.waitForElementVisible(findTestObject('FIND/SELLER/Add Item/input_PRICE'), 0)

WebUI.setText(findTestObject('FIND/SELLER/Add Item/input_PRICE'), '1500.15')

WebUI.comment('SKU')

WebUI.waitForElementVisible(findTestObject('FIND/SELLER/Add Item/input_ID'), 0)

WebUI.setText(findTestObject('FIND/SELLER/Add Item/input_ID'), 'GDA004')
...
WebUI.uploadFile(findTestObject('FIND/SELLER/Add Item/Image Upload/image_container'), 'C:\\\\Katalon\\\\FIND\\\\Images\\\\UN Items\\\\item4.jpg')
