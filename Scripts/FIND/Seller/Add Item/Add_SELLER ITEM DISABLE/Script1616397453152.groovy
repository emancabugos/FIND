...
WebUI.setText(findTestObject('FIND/SELLER/Add Item/input_ITEM NAME'), 'SELLER ITEM DISABLE')
...
WebUI.setText(findTestObject('FIND/SELLER/Add Item/input_ID'), 'GDA020')
...
WebUI.uploadFile(findTestObject('FIND/SELLER/Add Item/Image Upload/image_container'), 'C:\\\\Katalon\\\\FIND\\\\Images\\\\UN Items\\\\item20.jpg')
