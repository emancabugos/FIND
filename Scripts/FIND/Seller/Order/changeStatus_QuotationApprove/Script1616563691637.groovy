...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_orderStatus'), 'Quotation approved', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_orderStatus'), 'Quotation approved', false, 
    0)
