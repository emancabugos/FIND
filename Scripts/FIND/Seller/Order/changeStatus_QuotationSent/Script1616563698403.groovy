...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_orderStatus'), 'Quotation sent', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_orderStatus'), 'Quotation sent', false, 0)
