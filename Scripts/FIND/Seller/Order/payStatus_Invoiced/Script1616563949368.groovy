...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_paymentStatus'), 'Invoiced', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_paymentStatus'), 'Invoiced', false, 0)
