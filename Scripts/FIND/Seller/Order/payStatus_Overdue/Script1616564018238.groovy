...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_paymentStatus'), 'Overdue', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_paymentStatus'), 'Overdue', false, 0)
