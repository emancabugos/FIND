...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_paymentStatus'), 'Paid', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_paymentStatus'), 'Paid', false, 0)
