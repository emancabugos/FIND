...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_paymentStatus'), 'Payment Pending', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_paymentStatus'), 'Payment Pending', false, 
    0)
