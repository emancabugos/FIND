...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_shippingStatus'), 'Available', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_shippingStatus'), 'Available', false, 0)
