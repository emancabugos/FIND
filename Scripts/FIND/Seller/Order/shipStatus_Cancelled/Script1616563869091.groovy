...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_shippingStatus'), 'Cancelled', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_shippingStatus'), 'Cancelled', false, 0)
