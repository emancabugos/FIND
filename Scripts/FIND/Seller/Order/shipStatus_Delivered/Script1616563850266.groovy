...
WebUI.selectOptionByLabel(findTestObject('FIND/SELLER/Order Details/dd_shippingStatus'), 'Delivered', false)
...
WebUI.verifyOptionSelectedByLabel(findTestObject('FIND/SELLER/Order Details/dd_shippingStatus'), 'Delivered', false, 0)
