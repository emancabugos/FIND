...
WebUI.setText(findTestObject('FIND/SELLER/Your Items/item_searchbox'), 'DIABETES DIAGNOSTICS')
...
WebUI.verifyElementText(findTestObject('FIND/SELLER/Your Items/item_name'), 'DIABETES DIAGNOSTICS')
