...
WebUI.setText(findTestObject('FIND/SELLER/Your Items/item_searchbox'), 'HEPATITIS C & HIV DIAGNOSTICS')
...
WebUI.verifyElementText(findTestObject('FIND/SELLER/Your Items/item_name'), 'HEPATITIS C & HIV DIAGNOSTICS')
...
WebUI.setText(findTestObject('FIND/SELLER/Product Bundling/item_searchbox'), 'NTD DIAGNOSTICS')
