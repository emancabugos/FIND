...
WebUI.setText(findTestObject('FIND/SELLER/Your Items/item_searchbox'), 'MALARIA DIAGNOSTICS')
...
WebUI.verifyElementText(findTestObject('FIND/SELLER/Your Items/item_name'), 'MALARIA DIAGNOSTICS')
