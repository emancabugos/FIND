...
WebUI.setText(findTestObject('FIND/SELLER/Your Items/item_searchbox'), 'TUBERCULOSIS DIAGNOSTICS')
...
WebUI.verifyElementText(findTestObject('FIND/SELLER/Your Items/item_name'), 'TUBERCULOSIS DIAGNOSTICS')
